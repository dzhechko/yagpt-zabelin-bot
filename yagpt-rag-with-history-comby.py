...
def main():
    ...
    mdb_os_index_name_qa = st.secrets["MDB_OS_INDEX_NAME_QA"]
    ...
    if prompt := st.chat_input():
        ...
        # documents = [Document(page_content=text, metadata={'source': csv_file_path, 'page': i+1}) for i, text in enumerate(answers_list)]
